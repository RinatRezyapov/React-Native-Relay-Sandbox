...
const courses = [
  ...
  { id: '2', authorId: '1', title: 'Relay Description', body:  `Relay is designed for high performance at any scale. Relay keeps management of data-fetching easy, whether your app has tens, hundreds, or thousands of components. And thanks to Relay’s incremental compiler, it keeps your iteration speed fast even as your app grows.
  ...
  { id: '3', authorId: '1', title: 'React Native', body: `React primitives render to native platform UI, meaning your app uses the same native platform APIs other apps do.
